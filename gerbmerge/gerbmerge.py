...
Patched by KHK: added for Seeed Studio to generate an outline for all panelized gerber files
	from:   https://github.com/space-age-robotics/gerbmerge-patched/commit/5078c7b33439912c465fb33fc0082b82cfac3687#diff-0
...
KHK: Fixed a problem with metric GERBER and EXCELLON files from KiCAD
